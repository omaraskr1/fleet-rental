    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookedDays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookedDays_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookedDays_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookedDays_BookingId",
                table: "BookedDays",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_BookedDays_Date",
                table: "BookedDays",
                column: "Date");

            migrationBuilder.CreateIndex(
                name: "UX_BookedDays_Car_Date",
                table: "BookedDays",
                columns: new[] { "CarId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_CarId_Status",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarPhotos_CarId_SortOrder",
                table: "CarPhotos",
